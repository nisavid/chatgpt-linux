...
Enable the integration in the ignored `port-integrations/integrations.json` file:
...
Then rebuild and launch the app. The integration is disabled by default and does
