...
patch_record_replay_plugin_for_linux() {
    ...
    cp "$SCRIPT_DIR/port-integrations/record-and-replay/plugin-template/skills/record-and-replay/SKILL.md" \
...
plugin_template="$SCRIPT_DIR/port-integrations/record-and-replay/plugin-template"
