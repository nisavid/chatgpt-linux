...
```bash
CHATGPT_SKYSIGHT_OCR=auto|enabled|required|disabled
CHATGPT_CHRONICLE_OCR=auto|enabled|required|disabled
CHATGPT_SKYSIGHT_OCR_BACKEND=auto|rapidocr|tesseract
CHATGPT_CHRONICLE_OCR_BACKEND=auto|rapidocr|tesseract
CHATGPT_SKYSIGHT_RAPIDOCR_PYTHON=/path/to/python3
CHATGPT_CHRONICLE_RAPIDOCR_PYTHON=/path/to/python3
CHATGPT_SKYSIGHT_RAPIDOCR_LANG=ch
CHATGPT_CHRONICLE_RAPIDOCR_LANG=ch
CHATGPT_SKYSIGHT_TESSERACT_PATH=/path/to/tesseract
CHATGPT_CHRONICLE_TESSERACT_PATH=/path/to/tesseract
CHATGPT_SKYSIGHT_OCR_LANG=eng
CHATGPT_SKYSIGHT_OCR_PSM=11
CHATGPT_SKYSIGHT_OCR_TIMEOUT_MS=10000
```
...
1. Run `node --test port-integrations/record-and-replay/test.js`.
