...
const linuxReactRuntimeExport = "chatgptLinuxReact";
const linuxJsxRuntimeExport = "chatgptLinuxJsx";
...
function applyLinuxShortcutPhysicalKeyFallbackPatch(currentSource) {
  const patchMarker = "chatgptLinuxShortcutPhysicalKeyFallbackEvent";
  ...
  const patchedSource =
    `function ${functionName}(chatgptLinuxShortcutPhysicalKeyFallbackEvent){let{altKey:${altKeyLocal},code:${codeLocal},key:${keyLocal},ctrlKey:chatgptLinuxShortcutPhysicalKeyFallbackCtrl,metaKey:chatgptLinuxShortcutPhysicalKeyFallbackMeta}=chatgptLinuxShortcutPhysicalKeyFallbackEvent;return!(${altKeyLocal}||chatgptLinuxShortcutPhysicalKeyFallbackCtrl||chatgptLinuxShortcutPhysicalKeyFallbackMeta)||typeof chatgptLinuxShortcutPhysicalKeyFallbackEvent.getModifierState=="function"&&chatgptLinuxShortcutPhysicalKeyFallbackEvent.getModifierState("AltGraph")||${codeLocal}==null?${keyLocal}:${physicalFallbackExpression}}`;
