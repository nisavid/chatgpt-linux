...
function computerUseUiSettingsPath(env) {
  const override = env.CHATGPT_LINUX_SETTINGS_FILE;
...
function computerUseUiSettingsAppId(env) {
  const appId = env.CHATGPT_LINUX_APP_ID || env.CHATGPT_APP_ID || "chatgpt";
  return /^[A-Za-z0-9._-]+$/.test(appId) ? appId : "chatgpt";
}
...
function applyLinuxComputerUseFeaturePatch(currentSource) {
  ...
  const currentPatchedFeaturePattern =
    /let [A-Za-z_$][\w$]*=[A-Za-z_$][\w$]*===`linux`\?\{\.\.\.[A-Za-z_$][\w$]*,computerUse:!0,computerUseNodeRepl:!0\}:[A-Za-z_$][\w$]*===`win32`&&[A-Za-z_$][\w$]*\.CHATGPT_ELECTRON_ENABLE_WINDOWS_COMPUTER_USE===`1`\?\{\.\.\.[A-Za-z_$][\w$]*,computerUse:!0,computerUseNodeRepl:!0\}:[A-Za-z_$][\w$]*,/;
  const currentChainedPatchedFeaturePattern =
    /,[A-Za-z_$][\w$]*=[A-Za-z_$][\w$]*===`linux`\?\{\.\.\.[A-Za-z_$][\w$]*,computerUse:!0,computerUseNodeRepl:!0\}:[A-Za-z_$][\w$]*===`win32`&&[A-Za-z_$][\w$]*\.CHATGPT_ELECTRON_ENABLE_WINDOWS_COMPUTER_USE===`1`\?\{\.\.\.[A-Za-z_$][\w$]*,computerUse:!0,computerUseNodeRepl:!0\}:[A-Za-z_$][\w$]*,/;
  const windowsOnlyFeaturePattern =
    /function ([A-Za-z_$][\w$]*)\(([A-Za-z_$][\w$]*),\{env:([A-Za-z_$][\w$]*)=process\.env,platform:([A-Za-z_$][\w$]*)=process\.platform\}=\{\}\)\{return \4!==`win32`\|\|\3\.CHATGPT_ELECTRON_ENABLE_WINDOWS_COMPUTER_USE!==`1`\?\2:\{\.\.\.\2,computerUse:!0,computerUseNodeRepl:!0\}\}/g;
  const currentWindowsOnlyFeaturePattern =
    /let ([A-Za-z_$][\w$]*)=([A-Za-z_$][\w$]*)===`win32`&&([A-Za-z_$][\w$]*)\.CHATGPT_ELECTRON_ENABLE_WINDOWS_COMPUTER_USE===`1`\?\{\.\.\.([A-Za-z_$][\w$]*),computerUse:!0,computerUseNodeRepl:!0\}:\4,/g;
  const chainedWindowsOnlyFeaturePattern =
    /,([A-Za-z_$][\w$]*)=([A-Za-z_$][\w$]*)===`win32`&&([A-Za-z_$][\w$]*)\.CHATGPT_ELECTRON_ENABLE_WINDOWS_COMPUTER_USE===`1`\?\{\.\.\.([A-Za-z_$][\w$]*),computerUse:!0,computerUseNodeRepl:!0\}:\4,/g;
  ...
  let patchedSource = currentSource.replace(
    ...
    (_, fnName, featuresVar, envVar, platformVar) => {
      changed = true;
      return `function ${fnName}(${featuresVar},{env:${envVar}=process.env,platform:${platformVar}=process.platform}={}){return ${platformVar}===\`linux\`?{...${featuresVar},computerUse:!0,computerUseNodeRepl:!0}:${platformVar}!==\`win32\`||${envVar}.CHATGPT_ELECTRON_ENABLE_WINDOWS_COMPUTER_USE!==\`1\`?${featuresVar}:{...${featuresVar},computerUse:!0,computerUseNodeRepl:!0}}`;
    },
  );
  patchedSource = patchedSource.replace(
    ...
    (_, gateVar, platformVar, envVar, featuresVar) => {
      changed = true;
      return `let ${gateVar}=${platformVar}===\`linux\`?{...${featuresVar},computerUse:!0,computerUseNodeRepl:!0}:${platformVar}===\`win32\`&&${envVar}.CHATGPT_ELECTRON_ENABLE_WINDOWS_COMPUTER_USE===\`1\`?{...${featuresVar},computerUse:!0,computerUseNodeRepl:!0}:${featuresVar},`;
    },
  );
  patchedSource = patchedSource.replace(
    ...
    (_, gateVar, platformVar, envVar, featuresVar) => {
      changed = true;
      return `,${gateVar}=${platformVar}===\`linux\`?{...${featuresVar},computerUse:!0,computerUseNodeRepl:!0}:${platformVar}===\`win32\`&&${envVar}.CHATGPT_ELECTRON_ENABLE_WINDOWS_COMPUTER_USE===\`1\`?{...${featuresVar},computerUse:!0,computerUseNodeRepl:!0}:${featuresVar},`;
    },
  );
  ...
  if (currentSource.includes("CHATGPT_ELECTRON_ENABLE_WINDOWS_COMPUTER_USE")) {
    console.warn(
...
function applyLinuxNativeDesktopAppsHandlerPatch(currentSource) {
  ...
  const nativeAppsReplacement = replaceHandlerValue(
    patchedSource,
    "native-desktop-apps",
    (handler) => `async(...e)=>process.platform===\`linux\`?chatgptLinuxNativeDesktopApps(e[0]):await(${handler})(...e)`,
  );
  ...
  if (findHandlerValue(patchedSource, "computer-use-native-desktop-app-icon") == null) {
    const iconHandler =
      `"computer-use-native-desktop-app-icon":async(e)=>process.platform===\`linux\`?chatgptLinuxNativeDesktopAppIcon(e):{iconSmall:\`\`},`;
    patchedSource =
    ...
    const iconReplacement = replaceHandlerValue(
      ...
      (handler) => `async(...e)=>process.platform===\`linux\`?chatgptLinuxNativeDesktopAppIcon(e[0]):await(${handler})(...e)`,
    );
