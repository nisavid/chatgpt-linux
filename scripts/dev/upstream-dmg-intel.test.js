...
const registry = {
  ...
  surfaces: [
    ...
    },
    {
      ...
      linuxSubstrate: {
        requiredPaths: ["port-integrations/conversation-mode/patches.js"],
      },
    },
    {
    ...
    },
    {
      ...
      linuxSubstrate: {
        requiredPaths: ["port-integrations/record-and-replay"],
      },
    },
    {
      ...
      linuxSubstrate: {
        requiredPaths: ["port-integrations/future-skysight/patch.js"],
      },
    },
  ],
};
